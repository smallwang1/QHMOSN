package com.piesat.busiclogic.common.weather.calculator;


import com.piesat.busiclogic.common.weather.Location;
import com.piesat.busiclogic.common.weather.Zenith;
...
/**
 * Created by zhangfucai on 2015/11/3.
 */
public class SolarEventCalculator {
    ...
    private String getLocalTimeAsString(BigDecimal localTimeParam) {
        ...
        minutes = minutes.multiply(BigDecimal.valueOf(60)).setScale(0, RoundingMode.HALF_DOWN);
        ...
        String minuteString = StringUtils.leftPad(minutes.toPlainString(), 2, "0");
        String hourString = StringUtils.leftPad(String.valueOf(hour), 2, "0" );
    ...
    private BigDecimal getUTCOffSet(Calendar date) {
        ...
        return offSet.setScale(0, RoundingMode.HALF_DOWN);
    }
    ...
    private BigDecimal setScale(BigDecimal number) {
        return number.setScale(4, RoundingMode.HALF_DOWN);
    }
}
