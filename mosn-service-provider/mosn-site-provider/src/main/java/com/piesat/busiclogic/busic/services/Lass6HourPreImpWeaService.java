...
@Service
public class Lass6HourPreImpWeaService extends ImpWeaService {
	...
	protected void setConfig(Map<String, Map<String, Object>> config) {
		...
		over50.put(unit, "mm");
		over50.put(type, "过去6小时降水量达到50毫米");
		over50.put(name, "强降水");
		over50.put(image, "strongprec2.png");
		over50.put(colKey, "V13022");
	...
	protected String getCols() {
		return "D_DATETIME,V01301,V13022,v05001,v06001";
	}
